...
const TOC = [
  ...
  { id: "sobre-a-aplicacao", label: "Sobre a aplicação SocialPet" },
...
export function Termos() {
  return (
    <LegalPageLayout
      title="Termos de Uso"
      summary="As regras de uso deste site institucional, e a diferença entre navegar aqui e usar a aplicação SocialPet."
      toc={TOC}
    >
