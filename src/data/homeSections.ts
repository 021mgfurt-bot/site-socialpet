 ...
 * daqui no Prompt 6 — têm componente próprio (ProblemToSocialPet),
 * renderizado direto em Home.tsx. As demais continuam como placeholders
 * estruturais até serem desenhadas e implementadas.
 */
export const HOME_SECTIONS: HomeSectionConfig[] = [
  { id: "vacinacao", title: "Vacinação", tone: "paper" },
